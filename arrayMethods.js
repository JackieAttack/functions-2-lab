...
// CODE HERE
const myStrongest = monstersInYourPocket.filter((poke) => poke.CP > 200)
...
const afterTax = orders.map((obj) => obj.price * (1 + obj.tax))
...
const bobsTotal = purchases.filter((who) => who.owner === 'Bob').reduce((accum, curr) => accum + curr.price, 0)
